...
No-man's-land is not empty ground between two armies. It is thirty-seven years of war compacted into mud.
...
The approach nearest a trench is watched, shelled, wired, and repeatedly crossed. It contains marked routes, false markers, listening posts, corpse-hound tracks, and the remains of soldiers who almost returned.

### Deep Mud

Drainage has failed. Bodies descend slowly and return in pieces after rain. Movement leaves obvious tracks. Black Matter often collects beneath the water's surface in shapes resembling open eyes.
...
Weather should change what the map means.

- **Rain** fills craters, exposes Black Matter, and moves bodies downhill.
...
Use two or three senses, then stop.

- The click of cooling wire after a shell burst
- Mud pulling at boots with the rhythm of breathing
...
Avoid constant escalation. Alternate explicit bodily horror with absences, domestic remnants, and patterns that imply intention.

## Things Found in the Mud

1. An Allied corpse with tomorrow's date on its tag
2. A dry letter addressed to one of the sappers under a false name
3. A mine marked safe in the player's own handwriting
4. A living enemy hand still gripping a field telephone
5. A child's wooden horse repaired with human teeth
6. A corpse whose every replacement came from the same unknown donor
7. A field kitchen serving nobody, its stove still warm
